...
DIR<-"C:/Users/spl/Documents/Magnetic Nanoparticle with Cindi Dennis/"
if(!file.exists(paste(DIR,"Results",File.name,sep='/'))) dir.create(paste(DIR,"Results",File.name,sep='/'))
